...
var driver1Lauda = document.getElementById("driver1Lauda");
var driver1ImagemLauda = document.getElementById("driver1-imgLauda");
var lastro1Lauda = document.getElementById("lastro1Lauda");
var lastro1ImagemLauda = document.getElementById("lastro1-imgLauda");
var pontos1Lauda = document.getElementById("pontos1Lauda");
...
var driver2Lauda = document.getElementById("driver2Lauda");
var driver2ImagemLauda = document.getElementById("driver2-imgLauda");
var lastro2Lauda = document.getElementById("lastro2Lauda");
var lastro2ImagemLauda = document.getElementById("lastro2-imgLauda");
var pontos2Lauda = document.getElementById("pontos2Lauda");
...
var driver4Lauda = document.getElementById("driver4Lauda");
var driver4ImagemLauda = document.getElementById("driver4-imgLauda");
var lastro4Lauda = document.getElementById("lastro4Lauda");
var lastro4ImagemLauda = document.getElementById("lastro4-imgLauda");
var pontos4Lauda = document.getElementById("pontos4Lauda");
...
var driver5Lauda = document.getElementById("driver5Lauda");
var driver5ImagemLauda = document.getElementById("driver5-imgLauda");
var lastro5Lauda = document.getElementById("lastro5Lauda");
var lastro5ImagemLauda = document.getElementById("lastro5-imgLauda");
var pontos5Lauda = document.getElementById("pontos5Lauda");
...
var driver6Lauda = document.getElementById("driver6Lauda");
var driver6ImagemLauda = document.getElementById("driver6-imgLauda");
var lastro6Lauda = document.getElementById("lastro6Lauda");
var lastro6ImagemLauda = document.getElementById("lastro6-imgLauda");
var pontos6Lauda = document.getElementById("pontos6Lauda");
...
var driver7Lauda = document.getElementById("driver7Lauda");
var driver7ImagemLauda = document.getElementById("driver7-imgLauda");
var lastro7Lauda = document.getElementById("lastro7Lauda");
var lastro7ImagemLauda = document.getElementById("lastro7-imgLauda");
var pontos7Lauda = document.getElementById("pontos7Lauda");
...
var driver8Lauda = document.getElementById("driver8Lauda");
var driver8ImagemLauda = document.getElementById("driver8-imgLauda");
var lastro8Lauda = document.getElementById("lastro8Lauda");
var lastro8ImagemLauda = document.getElementById("lastro8-imgLauda");
var pontos8Lauda = document.getElementById("pontos8Lauda");
...
var driver9Lauda = document.getElementById("driver9Lauda");
var driver9ImagemLauda = document.getElementById("driver9-imgLauda");
var lastro9Lauda = document.getElementById("lastro9Lauda");
var lastro9ImagemLauda = document.getElementById("lastro9-imgLauda");
var pontos9Lauda = document.getElementById("pontos9Lauda");
...
var driver10Lauda = document.getElementById("driver10Lauda");
var driver10ImagemLauda = document.getElementById("driver10-imgLauda");
var lastro10Lauda = document.getElementById("lastro10Lauda");
var lastro10ImagemLauda = document.getElementById("lastro10-imgLauda");
var pontos10Lauda = document.getElementById("pontos10Lauda");

var driver11 = document.getElementById("driver11");
var driver11Imagem = document.getElementById("driver11-img");
var lastro11 = document.getElementById("lastro11");
...
var lastro13 = document.getElementById("lastro13");
...
var lastro15 = document.getElementById("lastro15");
...
var lastro17 = document.getElementById("lastro17");
...
var driver21 = document.getElementById("driver21");
var driver21Imagem = document.getElementById("driver21-img");
var lastro21 = document.getElementById("lastro21");
var lastro21Imagem = document.getElementById("lastro21-img");
...
var DecimaSextaPosicaoCorrida = "00"
var DecimaSetimaPosicaoCorrida = "00"
var DecimaOitavaPosicaoCorrida = "00"
var DecimaNonaPosicaoCorrida = "00"
var VigesimaPosicaoCorrida = "00"
...
var joãoAnselmoImagem = "pilotos/joaoAnselmo.png";

var felipeSilva = "Felipe <STRONG> SILVA </STRONG>";
var felipeSilvaImagem = "pilotos/FelipeSantos.png";
...
var fredBederImagem = "pilotos/fredBeder.png";

var raulSilva = "Raul <STRONG> SILVA </STRONG>";
var raulSilvaImagem = "pilotos/raulSilva.png";

var nelsonVianna = "Nelson <STRONG> VIANNA </STRONG>";
var nelsonViannaImagem = "pilotos/nelson-vianna.png";

var andersonRodrigues = "Anderson <STRONG> RODRIGUES </STRONG>";
var andersonRodriguesImagem = "pilotos/mazepin.png";
...
var andersonSilva = "Anderson <Strong> SILVA </Strong>";
var andersonSilvaImagem = "pilotos/mazepin.png";
...
var gutoDAVilla = "Guto <strong> D'AVILLA </strong>";
var gutoDAVillaImagem = "pilotos/mazepin.png";
var f1Noticias = "Guilherme <strong> SILVA </strong>";
var f1NoticiasImagem = "pilotos/f1Noticias.jpg";
var caioSchoereder = "Caio <strong> SCHOEREDER </strong>";
var caioSchoerederImagem = "pilotos/caioSchoereder.jpg";
...
var arthurZoppi = "Arthur <strong> ZOPPI </strong>";
var arthurZoppiImagem = "pilotos/arthurZoppi.jpg";
var alcebiadesAzevedo = "Alcebíades <strong> AZEVEDO </strong>";
var alcebiadesAzevedoImagem = "pilotos/alcebiadesAzevedo.jpg";
...
var zidaneThunder = "Zidade <strong> THUNDER </strong>";
var zidaneThunderImagem = "pilotos/mazepin.png";
var rafaelSarai = "Rafael <strong> SARAI </strong>";
var rafaelSaraiImagem = "pilotos/mazepin.png";
var robsonEmilio = "Robson <strong> EMÍLIO </strong>";
var robsonEmilioImagem = "pilotos/mazepin.png";
//Rafael Stahnke VAR criada já para a liga senna//
var pedroHenrique = "Pedro <strong> HENRIQUE </strong>";
var pedroHenriqueImagem = "pilotos/mazepin.png";
var marcoStahnke = "Marco <strong> STAHNKE </strong>";
var marcoStahnkeImagem = "pilotos/mazepin.png";
...
var alpine = "Alpine";
var alpineImagem = "equipes-f1/Alpine.png";

var alphaTauri = "Alpha Tauri";
var alphaTauriImagem = "equipes-f1/Alphatauri.png";

var haas = "Haas";
var haasImagem = "equipes-f1/Haas.png";
...
var PosicaoguilhermeBarrosFranca = QuintaPosicaoCorrida;
...
var PosicaoTalesMansoBelgica = SegundaPosicaoCorrida;
var PosicaoBrunoThomazBelgica = SetimaPosicaoCorrida;
var PosicaoJoaoAnselmoBelgica = QuartaPosicaoCorrida;
var PosicaoFelipeSilvaBelgica = QuintaPosicaoCorrida;
var PosicaoguilhermeBarrosBelgica = F;
var PosicaojailsonMouraBelgica = NC;//14°
var PosicaopabloMullerBelgica = NC;//15
var PosicaofredBederBelgica = F;
var PosicaoraulSilvaBelgica = F;
var PosicaonelsonViannaBelgica = TerceiraPosicaoCorrida;
var PosicaoandersonRodriguesBelgica = DecimaPrimeiraPosicaoCorrida;
var PosicaopedroPortelaBelgica = F;
var PosicaomuriloHenriqueBelgica = DecimaSextaPosicaoCorrida;
var PosicaojoaoVillaBelgica = F;
var PosicaorafaelStahnkeBelgica = NonaPosicaoCorrida;
var PosicaodouglasGobbsBelgica = OitavaPosicaoCorrida;
var PosicaofelipeAlmeidaBelgica = DecimaPosicaoCorrida;
var PosicaopauloHackbarthBelgica = SextaPosicaoCorrida;
var PosicaolucasPimentelBelgica = NC;//12°
var PosicaoAndersonSilvaBelgica = PrimeiraPosicaoCorrida;

// Posições corrida Japão ->

var PosicaoTalesMansoJapao = PrimeiraPosicaoCorrida;
var PosicaoBrunoThomazJapao = TerceiraPosicaoCorrida;
var PosicaoJoaoAnselmoJapao = QuartaPosicaoCorrida;
var PosicaoFelipeSilvaJapao = NC;//8°
var PosicaoguilhermeBarrosJapao = SegundaPosicaoCorrida;
var PosicaojailsonMouraJapao = SetimaPosicaoCorrida;
var PosicaopabloMullerJapao = NC;//14°
var PosicaofredBederJapao = F;
var PosicaoraulSilvaJapao = QuintaPosicaoCorrida;
var PosicaonelsonViannaJapao = NC;
var PosicaoandersonRodriguesJapao = NC;
var PosicaopedroPortelaJapao = F;
var PosicaomuriloHenriqueJapao = NC;
var PosicaojoaoVillaJapao = NC;
var PosicaorafaelStahnkeJapao = F;
var PosicaodouglasGobbsJapao = NC;
var PosicaofelipeAlmeidaJapao = SextaPosicaoCorrida;
var PosicaopauloHackbarthJapao = NC;
var PosicaolucasPimentelJapao = NC;
...
var PosicaoBetoReinertBelgicaSprint = NonaPosicaoSprint;
var PosicaoTalesMansoBelgicaSprint = PrimeiraPosicaoSprint;
var PosicaoBrunoThomazBelgicaSprint = SetimaPosicaoSprint;
var PosicaoJoaoAnselmoBelgicaSprint = DecimaPosicaoSprint;
var PosicaoFelipeSilvaBelgicaSprint = SextaPosicaoSprint;
var PosicaoguilhermeBarrosBelgicaSprint = F;
var PosicaojailsonMouraBelgicaSprint = DecimaPrimeiraPosicaoSprint;
var PosicaopabloMullerBelgicaSprint = DecimaTerceiraPosicaoSprint;
var PosicaofredBederBelgicaSprint = F;
var PosicaoraulSilvaBelgicaSprint = F;
var PosicaonelsonViannaBelgicaSprint = TerceiraPosicaoSprint;
var PosicaoandersonRodriguesBelgicaSprint = QuintaPosicaoSprint;
var PosicaopedroPortelaBelgicaSprint = F;
var PosicaomuriloHenriqueBelgicaSprint = OitavaPosicaoSprint;
var PosicaojoaoVillaBelgicaSprint = F;
var PosicaorafaelStahnkeBelgicaSprint = SegundaPosicaoSprint;
var PosicaodouglasGobbsBelgicaSprint = QuartaPosicaoSprint;
var PosicaofelipeAlmeidaBelgicaSprint = DecimaQuintaPosicaoSprint;
var PosicaopauloHackbarthBelgicaSprint = NC;//16°
var PosicaolucasPimentelBelgicaSprint = DecimaSegundaPosicaoSprint;
var PosicaoAndersonSilvaBelgicaSprint = DecimaQuartaPosicaoSprint;
...
var PosicaoGutoDAVillaBelgica = PrimeiraPosicaoCorrida;
var PosicaoGutoDAVillaBelgicaSprint = SegundaPosicaoSprint;
...
var PosicaoF1NoticiasBelgica = SegundaPosicaoCorrida;
var PosicaoF1NoticiasBelgicaSprint = TerceiraPosicaoSprint;
...
var PosicaoCaioSchoerederBelgica = OitavaPosicaoCorrida;
var PosicaoCaioSchoerederBelgicaSprint = OitavaPosicaoSprint;
...
var PosicaoEvertonAugustoBelgica = NC;//12°
var PosicaoEvertonAugustoBelgicaSprint = NC;//14°
...
var PosicaoJorgeLeaoBelgica = NonaPosicaoCorrida;
var PosicaoJorgeLeaoBelgicaSprint = QuintaPosicaoSprint;
...
var PosicaoLucasPipoxuBelgica = QuartaPosicaoCorrida;
var PosicaoLucasPipoxuBelgicaSprint = PrimeiraPosicaoSprint;
...
var PosicaoLucasPimentelLaudaBelgica = F;
var PosicaoLucasPimentelLaudaBelgicaSprint = F;
...
var PosicaoArthurZoppiBelgica = F;
var PosicaoArthurZoppiBelgicaSprint = F;
var PosicaoArthurZoppiJapao = NaC;
var PosicaoArthurZoppiAustria = NaC;
var PosicaoArthurZoppiBahrein = NaC;

// Alcebíades AZevedo
var PosicaoAlcebiadesAZevedoHungria = DecimaPrimeiraPosicaoCorrida;
...
var PosicaoAlcebiadesAZevedoBelgica = SetimaPosicaoCorrida;
var PosicaoAlcebiadesAZevedoBelgicaSprint = SetimaPosicaoSprint;
...
var PosicaoGuilhermmeLimaBelgica = SextaPosicaoCorrida;
var PosicaoGuilhermmeLimaBelgicaSprint = NC;//13°
...
var PosicaoFranciscoTiguilimBelgica = F;
var PosicaoFranciscoTiguilimBelgicaSprint = F;
...
var PosicaoJailsonMouraLaudaBelgica = TerceiraPosicaoCorrida;
var PosicaoJailsonMouraLaudaBelgicaSprint = DecimaSegundaPosicaoSprint;
...
var PosicaoLucasGuerraBelgica = QuintaPosicaoCorrida;
var PosicaoLucasGuerraBelgicaSprint = SextaPosicaoSprint;
...
var PosicaoZidaneThunderBelgica = F;
var PosicaoZidaneThunderBelgicaSprint = F;
...
var PosicaoRafaelSaraiBelgica = NC;//13°
var PosicaoRafaelSaraiBelgicaSprint = DecimaPosicaoSprint;
...
var PosicaoRobsonEmilioBelgica = NC;//14°
var PosicaoRobsonEmilioBelgicaSprint = NonaPosicaoSprint;
...
var PosicaoRafaelStahnkeLaudaBelgica = DecimaPrimeiraPosicaoCorrida;
var PosicaoRafaelStahnkeLaudaBelgicaSprint = QuartaPosicaoSprint;
...
var PosicaoPedroHenriqueBelgica = DecimaPosicaoCorrida;
var PosicaoPedroHenriqueBelgicaSprint = DecimaPrimeiraPosicaoSprint;
...
var PosicaoMarcoStahnkeBelgica = F;
var PosicaoMarcoStahnkeBelgicaSprint = F;
var PosicaoMarcoStahnkeJapao = NaC;
var PosicaoMarcoStahnkeAustria = NaC;
var PosicaoMarcoStahnkeBahrein = NaC;
...
//poles Lauda
var poleGutoDAVillaT9 = "2";
//Gp da França Et2 1:31,097
//GP DA BELGICA ET4 1:44,017 
...
var poleRobsonEmilioT9 = "0";
var poleRafaelStahnkeLaudaT9 = "0";
var polePedroHenriqueT9 = "0";
var poleMarcoStahnkeT9 = "0";



//Piloto do Dia

var PilotoDoDiaTalesMansoT9 = "3";
// GP DA FRANÇA
...
//Piloto do Dia Lauda
var PilotoDoDiaGutoDAVillaT9 = "0";
var PilotoDoDiaF1NoticiasT9 = "1";
///GP DA FRANCA ETP2
var PilotoDoDiaCaioSchoerederT9 = "0";
...
var PilotoDoDiaJailsonMouraLaudaT9 = "1";
//Provavelmente GP Da Bélgica
var PilotoDoDiaLucasGuerraT9 = "1";
//GP DA HUNGRIA ET1
var PilotoDoDiaZidaneThunderT9 = "0";
var PilotoDoDiaRafaelSaraiT9 = "0";
var PilotoDoDiaRobsonEmilioT9 = "0";
var PilotoDoDiaRafaelStahnkeLaudaT9 = "0";
var PilotoDoDiaPedroHenriqueT9 = "0";
var PilotoDoDiaMarcoStahnkeT9 = "0";
...
var MelhorVoltaJoaoAnselmoT9 = "1";
//GP DO JAPÃO 
...
var MelhorVoltaAndersonSilvaT9 = "1";
// GP DA BELGICA ETAPA 4 T9

//Melhor Volta Lauda
var MelhorVoltaGutoDAVillaT9 = "0";
var MelhorVoltaF1NoticiasT9 = "1";
//GP DA FRANÇA ETP2 1:33,434
var MelhorVoltaCaioSchoerederT9 = "1";
//GP DA BELGICA ET4 1:46,445
...
var MelhorVoltaRafaelSaraiT9 = "0";
var MelhorVoltaRobsonEmilioT9 = "0";
var MelhorVoltaRafaelStahnkeLaudaT9 = "0";
var MelhorVoltaPedroHenriqueT9 = "0";
var MelhorVoltaMarcoStahnkeT9 = "0";



//Contagem de Pontos Senna->
...
var poinstAndersonSilva = parseInt(PosicaoAndersonSilvaBelgica) + parseInt(PosicaoAndersonSilvaBelgicaSprint) + parseInt(MelhorVoltaAndersonSilvaT9);
var poinstBetoReinert = parseInt(PosicaoBetoReinertFranca) + parseInt(PosicaoBetoReinertBelgicaSprint);

//Contagem de Pontos Lauda->
var pointsGutoDAVilla = parseInt(PosicaoGutoDAVillaBelgicaSprint) + parseInt(PosicaoGutoDAVillaFrancaSprint) + parseInt(PilotoDoDiaGutoDAVillaT9) + parseInt(MelhorVoltaGutoDAVillaT9) + parseInt(poleGutoDAVillaT9) + parseInt(PosicaoGutoDAVillaHungria) + parseInt(PosicaoGutoDAVillaFranca) + parseInt(PosicaoGutoDAVillaHolanda) + parseInt(PosicaoGutoDAVillaBelgica) + parseInt(PosicaoGutoDAVillaJapao) + parseInt(PosicaoGutoDAVillaAustria) + parseInt(PosicaoGutoDAVillaBahrein);
var pointsF1Noticias = parseInt(PosicaoF1NoticiasBelgicaSprint) + parseInt(PosicaoF1NoticiasFrancaSprint) + parseInt(PilotoDoDiaF1NoticiasT9) + parseInt(MelhorVoltaF1NoticiasT9) +  parseInt(poleF1NoticiasT9) + parseInt(PosicaoF1NoticiasHungria) + parseInt(PosicaoF1NoticiasFranca) + parseInt(PosicaoF1NoticiasHolanda) + parseInt(PosicaoF1NoticiasBelgica) + parseInt(PosicaoF1NoticiasJapao) + parseInt(PosicaoF1NoticiasAustria) + parseInt(PosicaoF1NoticiasBahrein);
var pointsCaioSchoereder = parseInt(PosicaoCaioSchoerederBelgicaSprint) + parseInt(PosicaoCaioSchoerederFrancaSprint) + parseInt(PilotoDoDiaCaioSchoerederT9) + parseInt(MelhorVoltaCaioSchoerederT9) + parseInt(poleCaioSchoerederT9) + parseInt(PosicaoCaioSchoerederHungria) + parseInt(PosicaoCaioSchoerederFranca) + parseInt(PosicaoCaioSchoerederHolanda) + parseInt(PosicaoCaioSchoerederBelgica) + parseInt(PosicaoCaioSchoerederJapao) + parseInt(PosicaoCaioSchoerederAustria) + parseInt(PosicaoCaioSchoerederBahrein);
var pointsEvertonAugusto = parseInt(PosicaoEvertonAugustoBelgicaSprint) +  parseInt(PosicaoEvertonAugustoFrancaSprint) + parseInt(PilotoDoDiaEvertonAugustoT9) + parseInt(MelhorVoltaEvertonAugustoT9) + parseInt(poleEvertonAugustoT9) + parseInt(PosicaoEvertonAugustoHungria) + parseInt(PosicaoEvertonAugustoFranca) + parseInt(PosicaoEvertonAugustoHolanda) + parseInt(PosicaoEvertonAugustoBelgica) + parseInt(PosicaoEvertonAugustoJapao) + parseInt(PosicaoEvertonAugustoAustria) + parseInt(PosicaoEvertonAugustoBahrein);
var pointsJorgeLeao = parseInt(PosicaoJorgeLeaoBelgicaSprint) + parseInt(PosicaoJorgeLeaoFrancaSprint) + parseInt(PilotoDoDiaJorgeLeaoT9) + parseInt(MelhorVoltaJorgeLeaoT9) + parseInt(poleJorgeLeaoT9) + parseInt(PosicaoJorgeLeaoHungria) + parseInt(PosicaoJorgeLeaoFranca) + parseInt(PosicaoJorgeLeaoHolanda) + parseInt(PosicaoJorgeLeaoBelgica) + parseInt(PosicaoJorgeLeaoJapao) + parseInt(PosicaoJorgeLeaoAustria) + parseInt(PosicaoJorgeLeaoBahrein);
var pointsLucasPipoxu = parseInt(PosicaoLucasPipoxuBelgicaSprint) +  parseInt(PosicaoLucasPipoxuFrancaSprint) + parseInt(PilotoDoDiaLucasPipoxuT9) + parseInt(MelhorVoltaLucasPipoxuT9) + parseInt(poleLucasPipoxuT9) + parseInt(PosicaoLucasPipoxuHungria) + parseInt(PosicaoLucasPipoxuFranca) + parseInt(PosicaoLucasPipoxuHolanda) + parseInt(PosicaoLucasPipoxuBelgica) + parseInt(PosicaoLucasPipoxuJapao) + parseInt(PosicaoLucasPipoxuAustria) + parseInt(PosicaoLucasPipoxuBahrein);
var pointsLucasPimentelLauda = parseInt(PosicaoLucasPimentelLaudaBelgicaSprint) + parseInt(PosicaoLucasPimentelLaudaFrancaSprint) + parseInt(PilotoDoDiaLucasPimentelLaudaT9) + parseInt(MelhorVoltaLucasPimentelLaudaT9) + parseInt(poleLucasPimentelLaudaT9) + parseInt(PosicaoLucasPimentelLaudaHungria) + parseInt(PosicaoLucasPimentelLaudaFranca) + parseInt(PosicaoLucasPimentelLaudaHolanda) + parseInt(PosicaoLucasPimentelLaudaBelgica) + parseInt(PosicaoLucasPimentelLaudaJapao) + parseInt(PosicaoLucasPimentelLaudaAustria) + parseInt(PosicaoLucasPimentelLaudaBahrein);
var pointsArthurZoppi = parseInt(PosicaoArthurZoppiBelgicaSprint) + parseInt(PosicaoArthurZoppiFrancaSprint) + parseInt(PilotoDoDiaArthurZoppiT9) + parseInt(MelhorVoltaArthurZoppiT9) + parseInt(poleArthurZoppiT9) + parseInt(PosicaoArthurZoppiHungria) + parseInt(PosicaoArthurZoppiFranca) + parseInt(PosicaoArthurZoppiHolanda) + parseInt(PosicaoArthurZoppiBelgica) + parseInt(PosicaoArthurZoppiJapao) + parseInt(PosicaoArthurZoppiAustria) + parseInt(PosicaoArthurZoppiBahrein);
var pointsAlcebiadesAZevedo = parseInt(PosicaoAlcebiadesAZevedoBelgicaSprint) + parseInt(PosicaoAlcebiadesAZevedoFrancaSprint) + parseInt(PilotoDoDiaAlcebiadesAZevedoT9) + parseInt(MelhorVoltaAlcebiadesAZevedoT9) + parseInt(poleAlcebiadesAZevedoT9) + parseInt(PosicaoAlcebiadesAZevedoHungria) + parseInt(PosicaoAlcebiadesAZevedoFranca) + parseInt(PosicaoAlcebiadesAZevedoHolanda) + parseInt(PosicaoAlcebiadesAZevedoBelgica) + parseInt(PosicaoAlcebiadesAZevedoJapao) + parseInt(PosicaoAlcebiadesAZevedoAustria) + parseInt(PosicaoAlcebiadesAZevedoBahrein);
var pointsGuilhermmeLima = parseInt(PosicaoGuilhermmeLimaBelgicaSprint) + parseInt(PosicaoGuilhermmeLimaFrancaSprint) + parseInt(PilotoDoDiaGuilhermmeLimaT9) + parseInt(MelhorVoltaGuilhermmeLimaT9) + parseInt(poleGuilhermmeLimaT9) + parseInt(PosicaoGuilhermmeLimaHungria) + parseInt(PosicaoGuilhermmeLimaFranca) + parseInt(PosicaoGuilhermmeLimaHolanda) + parseInt(PosicaoGuilhermmeLimaBelgica) + parseInt(PosicaoGuilhermmeLimaJapao) + parseInt(PosicaoGuilhermmeLimaAustria) + parseInt(PosicaoGuilhermmeLimaBahrein);
var pointsLucasGuerra = parseInt(PosicaoLucasGuerraBelgicaSprint) + parseInt(PosicaoLucasGuerraFrancaSprint) + parseInt(PilotoDoDiaLucasGuerraT9) + parseInt(MelhorVoltaLucasGuerraT9) + parseInt(poleLucasGuerraT9) + parseInt(PosicaoLucasGuerraHungria) + parseInt(PosicaoLucasGuerraFranca) + parseInt(PosicaoLucasGuerraHolanda) + parseInt(PosicaoLucasGuerraBelgica) + parseInt(PosicaoLucasGuerraJapao) + parseInt(PosicaoLucasGuerraAustria) + parseInt(PosicaoLucasGuerraBahrein);
var poinstFranciscoTiguilim = parseInt(PosicaoFranciscoTiguilimBelgicaSprint) + parseInt(PosicaoFranciscoTiguilimFrancaSprint) + parseInt(PilotoDoDiaFranciscoTiguilimT9) + parseInt(MelhorVoltaFranciscoTiguilimT9) + parseInt(poleFranciscoTiguilimT9) + parseInt(PosicaoFranciscoTiguilimHungria) + parseInt(PosicaoFranciscoTiguilimFranca) + parseInt(PosicaoFranciscoTiguilimHolanda) + parseInt(PosicaoFranciscoTiguilimBelgica) + parseInt(PosicaoFranciscoTiguilimJapao) + parseInt(PosicaoFranciscoTiguilimAustria) + parseInt(PosicaoFranciscoTiguilimBahrein);
var poinstZidaneThunder = parseInt(PosicaoZidaneThunderBelgicaSprint) + parseInt(PosicaoZidaneThunderFrancaSprint) + parseInt(PilotoDoDiaZidaneThunderT9) + parseInt(MelhorVoltaZidaneThunderT9) + parseInt(poleZidaneThunderT9) + parseInt(PosicaoZidaneThunderHungria) + parseInt(PosicaoZidaneThunderFranca) + parseInt(PosicaoZidaneThunderHolanda) + parseInt(PosicaoZidaneThunderBelgica) + parseInt(PosicaoZidaneThunderJapao) + parseInt(PosicaoZidaneThunderAustria) + parseInt(PosicaoZidaneThunderBahrein);
var poinstRafaelStahnkeLauda = parseInt(PosicaoRafaelStahnkeLaudaBelgicaSprint) + parseInt(PosicaoRafaelStahnkeLaudaFrancaSprint) + parseInt(PilotoDoDiaRafaelStahnkeLaudaT9) + parseInt(MelhorVoltaRafaelStahnkeLaudaT9) + parseInt(poleRafaelStahnkeLaudaT9) + parseInt(PosicaoRafaelStahnkeLaudaHungria) + parseInt(PosicaoRafaelStahnkeLaudaFranca) + parseInt(PosicaoRafaelStahnkeLaudaHolanda) + parseInt(PosicaoRafaelStahnkeLaudaBelgica) + parseInt(PosicaoRafaelStahnkeLaudaJapao) + parseInt(PosicaoRafaelStahnkeLaudaAustria) + parseInt(PosicaoRafaelStahnkeLaudaBahrein);
var poinstPedroHenrique = parseInt(PosicaoPedroHenriqueBelgicaSprint) + parseInt(PosicaoPedroHenriqueFrancaSprint) + parseInt(PilotoDoDiaPedroHenriqueT9) + parseInt(MelhorVoltaPedroHenriqueT9) + parseInt(polePedroHenriqueT9) + parseInt(PosicaoPedroHenriqueHungria) + parseInt(PosicaoPedroHenriqueFranca) + parseInt(PosicaoPedroHenriqueHolanda) + parseInt(PosicaoPedroHenriqueBelgica) + parseInt(PosicaoPedroHenriqueJapao) + parseInt(PosicaoPedroHenriqueAustria) + parseInt(PosicaoPedroHenriqueBahrein);
var poinstRafaelSarai = parseInt(PosicaoRafaelSaraiBelgicaSprint) + parseInt(PosicaoRafaelSaraiFrancaSprint) + parseInt(PilotoDoDiaRafaelSaraiT9) + parseInt(MelhorVoltaRafaelSaraiT9) + parseInt(poleRafaelSaraiT9) + parseInt(PosicaoRafaelSaraiHungria) + parseInt(PosicaoRafaelSaraiFranca) + parseInt(PosicaoRafaelSaraiHolanda) + parseInt(PosicaoRafaelSaraiBelgica) + parseInt(PosicaoRafaelSaraiJapao) + parseInt(PosicaoRafaelSaraiAustria) + parseInt(PosicaoRafaelSaraiBahrein);
var poinstRobsonEmilio = parseInt(PosicaoRobsonEmilioBelgicaSprint) + parseInt(PosicaoRobsonEmilioFrancaSprint) + parseInt(PilotoDoDiaRobsonEmilioT9) + parseInt(MelhorVoltaRobsonEmilioT9) + parseInt(poleRobsonEmilioT9) + parseInt(PosicaoRobsonEmilioHungria) + parseInt(PosicaoRobsonEmilioFranca) + parseInt(PosicaoRobsonEmilioHolanda) + parseInt(PosicaoRobsonEmilioBelgica) + parseInt(PosicaoRobsonEmilioJapao) + parseInt(PosicaoRobsonEmilioAustria) + parseInt(PosicaoRobsonEmilioBahrein);
var poinstMarcoStahnke = parseInt(PosicaoMarcoStahnkeBelgicaSprint) + parseInt(PosicaoMarcoStahnkeFrancaSprint) + parseInt(PilotoDoDiaMarcoStahnkeT9) + parseInt(MelhorVoltaMarcoStahnkeT9) + parseInt(poleMarcoStahnkeT9) + parseInt(PosicaoMarcoStahnkeHungria) + parseInt(PosicaoMarcoStahnkeFranca) + parseInt(PosicaoMarcoStahnkeHolanda) + parseInt(PosicaoMarcoStahnkeBelgica) + parseInt(PosicaoMarcoStahnkeJapao) + parseInt(PosicaoMarcoStahnkeAustria) + parseInt(PosicaoMarcoStahnkeBahrein);
var poinstJailsonMouraLauda = parseInt(PosicaoJailsonMouraLaudaBelgicaSprint) + parseInt(PosicaoJailsonMouraLaudaFrancaSprint) + parseInt(PilotoDoDiaJailsonMouraLaudaT9) + parseInt(MelhorVoltaJailsonMouraLaudaT9) + parseInt(poleJailsonMouraLaudaT9) + parseInt(PosicaoJailsonMouraLaudaHungria) + parseInt(PosicaoJailsonMouraLaudaFranca) + parseInt(PosicaoJailsonMouraLaudaHolanda) + parseInt(PosicaoJailsonMouraLaudaBelgica) + parseInt(PosicaoJailsonMouraLaudaJapao) + parseInt(PosicaoJailsonMouraLaudaAustria) + parseInt(PosicaoJailsonMouraLaudaBahrein);
...
// inserção das informações SENNA ->
...
// Driver 8->
driver8.innerHTML = nelsonVianna;
driver8Imagem.setAttribute("src",nelsonViannaImagem);
lastro8.innerHTML = alphaTauri;
lastro8Imagem.setAttribute("src",alphaTauriImagem);
pontos8.innerHTML = poinstnelsonVianna;
...
// Driver 10->
driver10.innerHTML = andersonSilva;
driver10Imagem.setAttribute("src",andersonSilvaImagem);
lastro10.innerHTML = alpine;
lastro10Imagem.setAttribute("src",alpineImagem);
pontos10.innerHTML = poinstAndersonSilva;
...
// Driver 11->
driver11.innerHTML = felipeAlmeida;
driver11Imagem.setAttribute("src",felipeAlmeidaImagem);
lastro11.innerHTML = mcLaren;
lastro11Imagem.setAttribute("src",mcLarenImagem);
pontos11.innerHTML = poinstfelipeAlmeida;



// Driver 12->
driver12.innerHTML = pabloMuller;
driver12Imagem.setAttribute("src",pabloMullerImagem);
lastro12.innerHTML = mcLaren;
lastro12Imagem.setAttribute("src",mcLarenImagem);
pontos12.innerHTML = poinstpabloMuller;
...
// Driver 13->
driver13.innerHTML = rafaelStahnke;
driver13Imagem.setAttribute("src",rafaelStahnkeImagem);
lastro13.innerHTML = alfaRomeo;
lastro13Imagem.setAttribute("src",alfaRomeoImagem);
pontos13.innerHTML = poinstrafaelStahnke;
...
// Driver 14->
driver14.innerHTML = fredBeder;
driver14Imagem.setAttribute("src",fredBederImagem);
lastro14.innerHTML = alfaRomeo;
lastro14Imagem.setAttribute("src",alfaRomeoImagem);
pontos14.innerHTML = poinstfredBeder;
...
// Driver 15->
driver15.innerHTML = lucasPimentel;
driver15Imagem.setAttribute("src",lucasPimentelImagem);
lastro15.innerHTML = mercedes;
lastro15Imagem.setAttribute("src",mercedesImagem);
pontos15.innerHTML = poinstlucasPimentel;
...
// Driver 18->
driver18.innerHTML = pedroPortela;
driver18Imagem.setAttribute("src",pedroPortelaImagem);
lastro18.innerHTML = redbull;
lastro18Imagem.setAttribute("src",redbullImagem);
pontos18.innerHTML = poinstpedroPortela;
...
// Driver 19->
driver19.innerHTML = muriloHenrique;
driver19Imagem.setAttribute("src",muriloHenriqueImagem);
lastro19.innerHTML = "RESERVA";
pontos19.innerHTML = poinstmuriloHenrique;


// Driver 20->
driver20.innerHTML = betoReinert;
driver20Imagem.setAttribute("src",betoReinertImagem);
lastro20.innerHTML = ferrari;
lastro20Imagem.setAttribute("src",ferrariImagem);
pontos20.innerHTML = poinstBetoReinert;

// Driver 21->
driver21.innerHTML = joaoVilla;
driver21Imagem.setAttribute("src",joaoVillaImagem);
lastro21.innerHTML = ferrari;
lastro21Imagem.setAttribute("src",ferrariImagem);
pontos21.innerHTML = poinstjoaoVilla;


// inserção das informações LAUDA ->


// Driver 1 ->
driver1Lauda.innerHTML = gutoDAVilla;
driver1ImagemLauda.setAttribute("src",gutoDAVillaImagem);
lastro1Lauda.innerHTML = williams;
lastro1ImagemLauda.setAttribute("src",williamsImagem);
pontos1Lauda.innerHTML = pointsGutoDAVilla;

// Driver 2 ->
driver2Lauda.innerHTML = f1Noticias;
...
var piloto15 = document.getElementById("piloto15");
var piloto16 = document.getElementById("piloto16");
var piloto17 = document.getElementById("piloto17");
...
var piloto21 = document.getElementById("piloto21");
...
$(document).ready(function bla() {
    if($("#help").is(":visible"))
    {
        verMais.addEventListener('click',function(){
            ...
            $(piloto12).removeClass('hide');
            $(piloto13).removeClass('hide');
            $(piloto14).removeClass('hide');
            $(piloto15).removeClass('hide');
            $(piloto16).removeClass('hide');
            $(piloto17).removeClass('hide');
            $(piloto18).removeClass('hide');
            $(piloto19).removeClass('hide');
            $(piloto20).removeClass('hide');
            $(piloto21).removeClass('hide');
    ...
    else
    {
        verMais.addEventListener('click',function(){
            $(help).addClass('hide');
            $(piloto12).addClass('hide');
            $(piloto13).addClass('hide');
            $(piloto14).addClass('hide');
            $(piloto15).addClass('hide');
            $(piloto16).addClass('hide');
            $(piloto17).addClass('hide');
            $(piloto18).addClass('hide');
            $(piloto19).addClass('hide');
            $(piloto20).addClass('hide');
            $(piloto21).addClass('hide');
...
//Regulamento da Tabela RANKING -> 
// Os GPS só serão acrescentandos pós fim da temporada